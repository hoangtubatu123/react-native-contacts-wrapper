                ...
                switch(requestCode) {
                    case(CONTACT_REQUEST):
                        try {
                            ...
                            Cursor numberCursor = this.contentResolver.query(Phone.CONTENT_URI, null,
                                                        Phone.CONTACT_ID + " = ?",
                                                        new String[] {id + ""}, null);
                            ...
                            if(numberCursor.moveToFirst()){
                                do{
                                    String phone = numberCursor.getString(numberCursor.getColumnIndexOrThrow(Phone.NUMBER));
                                    phoneNumbers.pushString(phone);
                                } while (numberCursor.moveToNext());
                            }
                            numberCursor.close();
                            if(foundData) {
                                contactData.putArray("phoneNumbers", phoneNumbers);
